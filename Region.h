...
public:
    Region();
    Region(string name, int id, float incidence);
    ~Region();
    ...
    inline void setDis1Incidence(float Dis1incidence) { _Dis1incidence = Dis1incidence; };
    inline void setDis2Incidence(float Dis2incidence) { _Dis2incidence = Dis2incidence; };
